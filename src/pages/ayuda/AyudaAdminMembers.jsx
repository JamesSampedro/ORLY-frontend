...
import { RECIPIENTS } from './AyudaAdminMembersColumns';
          ...
          <div className="equipment-inventory-page page">
                    <div className="residents-table-wrapper">
                    {
                       recipientsData.length > 0 ?
                        ...
                        <h1 style={{textAlign: "center"}}>No Members Available</h1>
...
export default AyudaAdminMembers