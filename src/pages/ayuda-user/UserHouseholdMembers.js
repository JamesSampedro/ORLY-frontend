...
import { RECIPIENTS } from './HouseholdColumns';
...
import axios from 'axios';
 ...
 const UserHouseholdMembers = () => {
    ...
    // const recipientsData = [{"id":1,"firstName":"New","lastName":"Test","address":"Blk. Test"},
    // {"id":2,"firstName":"Test","lastName":"New","address":"Blk. Test New"}]
    ...
    return (
        <>
        <h1 className="page-header-user">{programName} - {householdName}</h1>
...
export default UserHouseholdMembers